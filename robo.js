 ...
 */
 ...
 var legMatrix = new Matrix4().setTranslate(2.0, -12, 0);
 /**  @type {Matrix4} */
 ...
 /**  @type {Matrix4} */
 var rightlegMatrix = new Matrix4().setTranslate(-2.0, -12, 0);
 /**  @type {Matrix4} */
 ...
 var legMatrixLocal = new Matrix4().setScale(3, 10, 3);
 ...
 var rightlegMatrixLocal = new Matrix4().setScale(3, 10, 3);
   ...
   switch (ch) {
     ...
     case "F":
       ...
       var currentLegRot = new Matrix4()
         ...
         .translate(0, -2, 0);
       legMatrix.setTranslate(2.0, -12, 0).multiply(currentLegRot);
       break;
       case "z":
       legAngle += 15;
       var currentLegRot = new Matrix4()
       ...
       var currentLegRot = new Matrix4()
         ...
         .translate(0, -2, 0);
       rightlegMatrix.setTranslate(-2.0, -12, 0).multiply(currentLegRot);
       break;
       case "c":
       rightlegAngle += 15;
       var currentLegRot = new Matrix4()
